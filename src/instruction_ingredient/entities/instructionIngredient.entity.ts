...
export class InstructionIngredient {
    ...
    @ManyToOne(() => Instruction, (instruction) => instruction.instructionIngredients)
    @JoinColumn({ name: 'instruction_id' })
    instruction: Instruction;

    @PrimaryColumn({ name: 'ingredient_id', type: 'int' })
    @ManyToOne(() => Ingredient, (ingredient) => ingredient.instructionIngredients)
    ...
    @ManyToOne(() => AmountUnit, (amountUnit) => amountUnit.instructionIngredients)
